<template>
  <div class="app-container">
    <div>
      <span style="font-size: 14px;color: #606266;font-weight: 700;margin-right: 10px">会议名称</span>
...
<!--                style="width: 150px;margin-right: 30px"/>-->
      <span style="font-size: 14px;color: #606266;font-weight: 700;margin-right: 10px">会议日期</span>
      <el-date-picker
...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="comdata.slice((currentPage - 1) * pageSize, currentPage * pageSize)">
      <el-table-column label="会议标题" align="center" prop="companyName"/>
      <el-table-column label="会议室" align="center" prop="address"/>
      <el-table-column label="会议日期" align="center" prop="getWaterType"/>
      <el-table-column label="会议开始时间" align="center" prop="legalRepresentative"/>
      <el-table-column label="会议结束时间" align="center" prop="contactName" :show-overflow-tooltip="true"/>
